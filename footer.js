document.write(`
<footer class=" text-center text-lg-start text-white" style="background:#181818">
<!-- Grid container -->
<div class="container p-4"  style="background:#181818">
    <!--Grid row-->
    <div class="row my-4">
        <!--Grid column-->
...
<div class="logo-container d-flex align-items-center justify-content-center mb-4 mx-auto"
    ...
    <img src="goura-img/logo.png" alt="Hotel Goura Logo" loading="lazy" 
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0 tt">
            <h5 class=" mb-4" style="color: white; text-align: left;">Contact</h5>
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0 tt">
            <h5 class=" mb-4" style="color: white; text-align: left;">Quick Links</h5>
